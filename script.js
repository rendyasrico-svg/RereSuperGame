...
const loadInterval = setInterval(() => {
    ...
    if (loadProgress >= 100) {
        ...
        // Tunggu sebentar lalu masuk intro
        setTimeout(() => {
...
const fireHitSound = new Audio("assets/fire_hit.mp3");
const enemyDeadSound = new Audio("assets/enemy_dead.mp3");
...
// Saat pindah tab atau aplikasi di-minimize
...
// Saat browser kehilangan fokus
window.addEventListener("blur", () => {
    bgm.pause();
});

// Saat kembali ke game
...
// ====================
// PROYEKTIL (BOLA API)  <-- TAMBAHAN
// ====================
let projectiles = [];
let shootCooldown = 0;
const SHOOT_COOLDOWN_MAX = 20; // frame
...
const shootBtn = document.getElementById("shoot"); // TAMBAHAN
